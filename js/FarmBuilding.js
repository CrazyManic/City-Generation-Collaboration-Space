...
const farmHouseGeo = new THREE.BoxGeometry(gridSize/3, 5,gridSize/3);
const buildingpos_offset = buildingWidth/3 - 2;
...
class FarmBuilding extends Building{
    Generate(urbanness, pColor1, pColor2, pColor3){
        ...
        this.farmHouseMesh.position.set(this.position.x + buildingpos_offset, this.position.y + 5/2, this.position.z + buildingpos_offset);
